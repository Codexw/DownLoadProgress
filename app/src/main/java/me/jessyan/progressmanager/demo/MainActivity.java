...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public String mDownloadUrl = new String("https://raw.githubusercontent.com/iielse/behavior-learn/master/preview2.gif");
...
//                    response.body();
                    ...
                    Call<ResponseBody> call = mApi.getRequestCall(body);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    File file = new File("/mnt/sdcard/Test/test.gif");
                    if(!directory.exists()){
                        directory.mkdir();
                    }
